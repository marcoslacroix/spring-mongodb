...
import com.example.projectspring.dto.AuthorDTO;
import com.example.projectspring.dto.CommentDTO;
...
public class Instanciation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post3 = new Post(null, sdf.parse("25/04/2018"), "Verão chegou", "Vou ir surfar nesse calorzão",
                new AuthorDTO(alex));
        Post post4 = new Post(null, sdf.parse("26/04/2018"), "Bom dia #partiusurf", "Mais um dia de treino bora",
                new AuthorDTO(alex));

        postRepository.saveAll(Arrays.asList(post3, post4));
